"""
Django settings for blackcreek project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"],  # or [] if you don't have custom templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
INSTALLED_APPS = [
    ...
    'blackcreek.features.crops',
    'blackcreek.features.livestock',
...
ROOT_URLCONF = 'blackcreek.urls'

blackcreek = [
    {
        'BACKEND': 'django.template.backends.django.Djangoblackcreek',
        'DIRS': [os.path.join(BASE_DIR, 'blackcreek')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
...
WSGI_APPLICATION = 'blackcreek.wsgi.application'
